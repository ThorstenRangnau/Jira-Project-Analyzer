...
java -Xms24g -Xmx48g -jar $TMPDIR/Arcan-1.4.0-SNAPSHOT.jar -p /home/s3570282/ondemand/data/accumulo/ -git -out /data/s3570282/results/accumulo_arcan_analysis/ -singleVersion -branch master -nWeeks 0