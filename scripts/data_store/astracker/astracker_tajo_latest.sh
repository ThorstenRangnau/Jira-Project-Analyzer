...
cp /home/s3570282/ondemand/data/astracker-latest/astracker-1.0.0-jar-with-dependencies.jar $TMPDIR
...
java -Xmx3g -jar $TMPDIR/astracker-1.0.0-jar-with-dependencies.jar -i $TMPDIR/tajo_arcan_analysis/ -p tajo -o /data/pg-search/astracker_master_results/astracker_tajo_latest/ -pC -tNCS 1000