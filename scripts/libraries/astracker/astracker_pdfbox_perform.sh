...
java -Xmx96g -jar $TMPDIR/astracker-1.0.0-jar-with-dependencies.jar -i $TMPDIR/pdfbox_arcan_analysis/ -p pdfbox -o /data/s3570282/results/pdfbox_astracker_analysis/new_test_perform/ -pC